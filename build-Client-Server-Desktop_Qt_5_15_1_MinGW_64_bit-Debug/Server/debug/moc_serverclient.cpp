...
#include <memory>
#include "../../../app/Server/serverclient.h"
...
QT_MOC_LITERAL(1, 13, 16), // "socketDisconnect"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 12) // "onDisconnect"

    },
    "ServerClient\0socketDisconnect\0\0"
    "onDisconnect"
};
...
void ServerClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->socketDisconnect((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (ServerClient::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerClient::socketDisconnect)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ServerClient::socketDisconnect(int _t1)
{
