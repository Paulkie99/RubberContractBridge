...
#include <memory>
#include "../../Qt_Project/scoreboard.h"
...
QT_MOC_LITERAL(1, 11, 22), // "on_ScoreBoard_finished"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 6) // "result"

    },
    "ScoreBoard\0on_ScoreBoard_finished\0\0"
    "result"
};
...
void ScoreBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_ScoreBoard_finished((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
