...
//This function is used to update the values on the scoreboard. It takes the entire history of the game and interpretes it. Totals are calculated for each team and the appropriate
//slots on the scoreboard are updated to reflect score.
